...
CREATE TYPE "sales"."transactions_type" AS ENUM('SALE', 'RETURN');--> statement-breakpoint
...
CREATE TABLE "sales"."transactions" (
	"id" bigserial PRIMARY KEY NOT NULL,
	"type" "sales"."transactions_type" NOT NULL,
...
ALTER TABLE "procurement"."purchases" ADD CONSTRAINT "purchases_supplier_id_suppliers_id_fk" FOREIGN KEY ("supplier_id") REFERENCES "procurement"."suppliers"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "sales_daily_summary_product_date_unique" ON "analytics"."sales_daily_summary" USING btree ("product_id","created_at");--> statement-breakpoint
...
CREATE INDEX "products_name_idx" ON "catalog"."products" USING btree ("name");--> statement-breakpoint
...
CREATE INDEX "stock_movements_product_created_idx" ON "inventory"."stock_movements" USING btree ("product_id","created_at");--> statement-breakpoint
...
CREATE INDEX "stock_snapshots_product_calculated_idx" ON "inventory"."stock_snapshots" USING btree ("product_id","calculated_at");--> statement-breakpoint
...
CREATE INDEX "purchases_supplier_idx" ON "procurement"."purchases" USING btree ("supplier_id");--> statement-breakpoint
